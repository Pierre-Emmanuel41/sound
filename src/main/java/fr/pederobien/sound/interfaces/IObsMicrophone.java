...
public interface IObsMicrophone {
	 ...
	 * better to do it on a separated thread. The bytes array correspond to a mono signal, but should be transformed to a stereo
	 * signal in order to be played correctly by the speakers.
	 * 
